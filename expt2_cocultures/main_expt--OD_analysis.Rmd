...
annotation <- read.csv("annotation_for_alldata.csv")
...
I compared the results (below) and found that the second option works better. I will use this.
...
write.csv(latest_time %>% select(uniqID, Day),
          file="./extinctOD_wells.csv", quote=FALSE, row.names=FALSE)
...
load("./absolute_density_data.RData")
